...
index structure --- signed counters, bidirectional approximation
indices, anything descending without bound --- yields every iProp
...
not hold.  The standard candidates --- $\omega$, products like
$\omega \times \omega$, ordinals up to a bound, Transfinite
Iris~\cite{spies2021transfinite} --- all pass the check.  Our
