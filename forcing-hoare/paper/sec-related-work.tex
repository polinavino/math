...
\citeyearpar{appel-mcallester2001} to give a semantic account of recursive
...
framework.  Ahmed \citeyearpar{ahmed2004} extended the technique to
...
\citeyearpar{birkedal-et-al-2011-stepindexed} scaled it to capability calculi.
The \emph{later} modality $\triangleright$ was introduced by
Nakano \citeyearpar{nakano2000} as a modality for recursion, and
brought into the step-indexed logical-relations setting by Appel,
Melli\`es, Richards, and Vouillon \citeyearpar{appel-melham-mcallester2007}
to guard the step-indexed recursion syntactically.

The categorical reformulation is due to Birkedal, Møgelberg,
Schwinghammer, and Støvring \citeyearpar{birkedal-et-al-2012}: step-indexed
...
literature, though \citet{jaber-tabareau-sozeau-2012} frame their
type translation as a forcing construction and identify its integer
instance with the topos of trees.  We make the terminology explicit
in the step-indexed Hoare logic setting.
...
McBride \citeyearpar{atkey-mcbride2013} use $\triangleright$ to characterize
productive coprogramming, and Clouston, Bizjak, Grathwohl, and
Birkedal \citeyearpar{clouston-et-al-2015,clouston-et-al-2017} develop
guarded $\lambda$-calculi with $\triangleright$ as a primitive type
former. Møgelberg and others \citeyearpar{mogelberg2014,bizjak-mogelberg-2018}
...
Jaber, Tabareau, and Sozeau \citeyearpar{jaber-tabareau-sozeau-2012} give a
...
\emph{converse well-founded}. See Smoryński \citeyearpar{smorynski1985} and
Boolos \citeyearpar{boolos1993}.
