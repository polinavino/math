...
identity, the theorem also reads $v = \mu \circ \Box$, i.e. 
...
over the finite stages.  Requiring that approximation, i.e. Scott
continuity, restores the representation:
...
Theorem~\ref{thm:obstruction} demonstrates a failure of Scott
continuity (\texttt{topIndicator\_not\_scott}).  In general, on
...
phenomenon behind the undecidability of Section~\ref{sec:bridges}.
