...
A \emph{frame} is a complete lattice in which finite meets
...
modularity survives only as the inequality
$v(a) + v(b) \le v((a \sqcup b)^{\mathsf{cc}}) + v(a \sqcap b)$,
the 2-monotonicity of Section~\ref{sec:ds}.  A regular but uncomplemented
