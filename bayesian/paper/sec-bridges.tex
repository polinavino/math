...
for $b \in B$. \emph{Stone duality} identifies Boolean algebras with
exactly the compact, Hausdorff, totally disconnected spaces arising
this way.  A \emph{Stonean space} is a compact Hausdorff space that
...
non-degenerate models satisfying it.
