...
Dutch-book arguments~\cite{weatherson2003}.  Paris treats
non-classical uncertain reasoning broadly~\cite{paris1994}.  The
identification $\Bel = P(\Box\,\cdot)$ connecting belief
functions~\cite{dempster1967,shafer1976} to modal logic is
classical~\cite{ruspini1986}.  On the localic side, valuations on
...
frames we examine), so our base structure omits it.  The Cox line,
through Cox, Jaynes, Halpern's counterexample, and the Van Horn and
Arnborg--Sj\"odin
repairs~\cite{cox1946,jaynes2003,halpern1999,vanhorn2003,
arnborg-sjodin2000}, is classical throughout.  Van Horn observes
that dropping axiom R3 yields a two-number theory, exactly the
...
We claim the first mechanization of that development, not of
